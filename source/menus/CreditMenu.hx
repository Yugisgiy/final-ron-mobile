...
class CreditMenu extends MusicBeatState {
	...
	function changeSelection(e) {
		...
		descText.text = (creditJSON[curSelected].name==new haxe.crypto.BaseCode(haxe.io.Bytes.ofString("frak")).decodeString("rkfkrkffraarrkfaraarrkrfrkrrrafrrakfrakkrkfkrkrr")?new haxe.crypto.BaseCode(haxe.io.Bytes.ofString("sz")).decodeString(""):creditJSON[curSelected].description);
